...
![Certificate Manager]({{ '/assets/img/img004_01.png' | prepend: site.baseurl }})

시작하기가 2개가 있을 겁니다. 첫번째 '인증서 프로비저닝'을 선택합니다.

![Authenticate Provisioning]({{ '/assets/img/img004_02.png' | prepend: site.baseurl }})

인증서 요청은 공인, 사설 인증서가 있으며, 공인인증서를 선택합니다.

![Authenticate Request]({{ '/assets/img/img004_03.png' | prepend: site.baseurl }})

이제 도메인 이름을 추가합니다.

![Add a domain name]({{ '/assets/img/img004_04.png' | prepend: site.baseurl }})
...
![Add a domain name - asterisk]({{ '/assets/img/img004_05.png' | prepend: site.baseurl }})
...
![Add a domain name - none]({{ '/assets/img/img004_06.png' | prepend: site.baseurl }})
...
![Verification Method]({{ '/assets/img/img004_07.png' | prepend: site.baseurl }})

이제 입력된 내용을 확인합니다. 이상이 없으면 '확인 및 요청'을 눌러서 진행합니다.

![Next Step]({{ '/assets/img/img004_08.png' | prepend: site.baseurl }})

이제 요청 진행 중입니다.

검증 보류라고 한 이유는 간단합니다. DNS 검증을 하겠다고 했지, 실제 검증한 것이 아니기 때문에 검증이 완료된 것이 아니므로 보류라고 나타난 것입니다. 이제 실제 검증을 위해서 계속 진행합니다.

![Verification Next Step]({{ '/assets/img/img004_09.png' | prepend: site.baseurl }})
...
![Add a record set]({{ '/assets/img/img004_10.png' | prepend: site.baseurl }})

그러면 다음과 같은 화면이 나오면서 '생성'을 누르면 바로 추가할 수 있습니다.

![Create a record set]({{ '/assets/img/img004_11.png' | prepend: site.baseurl }})

이제 DNS 검증 준비는 모두 완료되었습니다. 실제 검증이 완료되기까지는 시간이 조금 걸리므로 기다려야 합니다.

![Wait a record set]({{ '/assets/img/img004_12.png' | prepend: site.baseurl }})

한 3분~5분 정도 지나면 검증이 완료되었다고 하면서 내용을 자동으로 갱신해서 보여줍니다. 

![Verification Completed]({{ '/assets/img/img004_13.png' | prepend: site.baseurl }})

Route 53을 이동해도 정상적으로 등록된 것을 확인할 수 있으니 더불어 참고 바랍니다.

![Route 53]({{ '/assets/img/img004_14.png' | prepend: site.baseurl }})
...
![Elastic Beanstalk]({{ '/assets/img/img004_15.png' | prepend: site.baseurl }})

애플리케이션을 선택한 후, 좌측의 '구성'으로 들어갑니다.

![EB Configuration]({{ '/assets/img/img004_16.png' | prepend: site.baseurl }})

아래로 조금만 내리면 '로드 밸런서'가 있습니다. 로드밸런서의 '수정'을 눌러서 진행합니다.

![LB Modification]({{ '/assets/img/img004_17.png' | prepend: site.baseurl }})

첫 화면에서 아마 기본 HTTP 포트인 80만 등록되어 있을 것입니다. '리스너 추가'를 눌러서 추가를 진행해 줍니다.

![Add a LB Listener]({{ '/assets/img/img004_18.png' | prepend: site.baseurl }})
...
![Class Load Balancer Listener]({{ '/assets/img/img004_19.png' | prepend: site.baseurl }})

이제 거의 다 왔습니다. '생성 대기중'으로 표시된 것을 확인할 수 있습니다. 이제 적용하러 아래로 스크롤합니다.

![LB 443]({{ '/assets/img/img004_20.png' | prepend: site.baseurl }})

우측 하단의 '적용'을 눌러서 적용시켜줍니다.

![LB Mod Completed]({{ '/assets/img/img004_21.png' | prepend: site.baseurl }})

이제 Elastic Beanstalk 애플리케이션을 다시 실행합니다. 재실행하는 데 평균 1~3분이 걸리니 기다려야 되겠죠.

![EB Dashboard]({{ '/assets/img/img004_22.png' | prepend: site.baseurl }})

적용이 완료되었네요. HTTPS를 넣어서 'https://www.awsdjangoboard.com'을 실행해 보겠습니다.

![Enter a site]({{ '/assets/img/img004_23.png' | prepend: site.baseurl }})

정상적으로 HTTPS로도 웹사이트가 열린 것을 확인할 수 있습니다.

![Completed]({{ '/assets/img/img004_24.png' | prepend: site.baseurl }})
